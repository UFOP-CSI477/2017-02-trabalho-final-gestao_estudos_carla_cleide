...
@section('header')
    ...
    <link rel="stylesheet" href="<?php echo asset('css/horario-layout.css')?>" type="text/css">
    <!-- script necessário para suporte ao calendário-- >
    <script type="text/javascript" src="<?php echo asset('js/horario.js')?>"></script>
        	...
        	<div class="events">
        		<ul>
        			<li class="events-group">
        				...
        				<ul>
        					<li class="single-event" data-start="09:00" data-end="10:00" data-content="event-abs-circuit" data-event="event-1">
        						<a href="#0">
